package com.live.test.api.core.config;
...
import com.live.test.api.core.convertor.DatatypeConvertUtil;
import com.live.test.api.core.convertor.IOConvertor;
...
//    static void init() {
    public static void init() {
        ...
        //初始化某些配置?
//        defaultProperty.setProperty("jdbc.url", "jdbc:mysql://127.0.0.1:3306/spim2.0?useunicode=true&amp;characterEncoding=utf-8");
